...
class P2World extends egret.DisplayObjectContainer {
    ...
    /**创建四面墙刚体*/
    public createWall(rect:egret.Rectangle):void
    {
        this.createPlane(0,0,0);//上
        this.createPlane(-Math.PI/2,0,0);//左
        this.createPlane(Math.PI,0,rect.height);//下
        this.createPlane(Math.PI/2,rect.width,0);//右
    }
    /**创建平面刚体*/
