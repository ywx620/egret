...
(function (control) {
    var ControlBasic = (function () {
        ...
        /** 手指移动*/
        ControlBasic.prototype.controlMove = function (x, y) {
        };
        /** 手指离开*/
    ...
    var ControlBarMove = (function (_super) {
        ...
        ControlBarMove.prototype.controlMove = function (x, y) {
    ...
    var ControlFingerMove = (function (_super) {
        ...
        ControlFingerMove.prototype.onTouch = function (e) {
            switch (e.type) {
                case egret.TouchEvent.TOUCH_BEGIN:
        ...
        /** 手指按下*/
        ControlFingerMove.prototype.controlStart = function () {
            _super.prototype.controlStart.call(this);
            if (this.startBackFun != null) {
                this.startBackFun(this.posStart);
            }
        };
        ControlFingerMove.prototype.controlMove = function (x, y) {
        };
    ...
    var ControlDrag = (function (_super) {
        ...
        ControlDrag.prototype.controlMove = function (x, y) {
