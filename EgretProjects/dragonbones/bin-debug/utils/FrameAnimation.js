...
var FrameAnimation = (function (_super) {
     ...
     */
    FrameAnimation.prototype.getArmatureByName = function (factoryName, armatureName) {
        var factory = this.data[factoryName];
     ...
     * 通过工厂名与骨架名得到可显示对象
     */
    FrameAnimation.prototype.getDisplayByName = function (factoryName, armatureName) {
        return this.getArmatureByName(factoryName, armatureName).getDisplay();
    };
    /***
     * 通过工厂名与骨架名得到动画控制
     */
    FrameAnimation.prototype.getAnimationByName = function (factoryName, armatureName) {
        return this.getArmatureByName(factoryName, armatureName).animation;
    };
    /**得到动画显示对象并且播放动画 */
    FrameAnimation.prototype.getAnimationSpriteByName = function (factoryName, animationName) {
        var sprite;
        ...
        var armature = this.getArmatureByName(factoryName, animationName);
